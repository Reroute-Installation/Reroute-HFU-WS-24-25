...
void setup(void) 
{
  ...
  pinMode(TelefonHoerer, INPUT_PULLUP);
...
void loop() 
{
  ...
  //Hörer abgehoben --> Lampe an
  if (digitalRead(TelefonHoerer) == LOw)
  {
    digitalWrite(Lampe, HIGH);
  }
 //Hörer aufgelegt --> Lampe aus
  if (digitalRead(TelefonHoerer) == HIGH)
  {
